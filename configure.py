...
def build_rules(n, args):
    ...
    n.variable("cxxlinkflags", "-static-libstdc++ -static-libgcc -static  -lallegro_monolith-static -ljpeg -lvorbis -logg -lglu32 -lopengl32 -lfreetype -lpng16 -lz -lkernel32 -luser32 -lgdi32 -lcomdlg32 -lole32 -ldinput -lddraw -ldxguid -lwinmm -ldsound -lwsock32 -lpsapi -lshlwapi")
